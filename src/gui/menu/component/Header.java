...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMenu = new gui.menu.swing.Button();
        pic = new gui.menu.swing.ImageAvatar();
        lbUserName = new javax.swing.JLabel();
        lbRole = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        buttonBadges1 = new gui.menu.swing.ButtonBadges();
        buttonBadges2 = new gui.menu.swing.ButtonBadges();

        setBackground(new java.awt.Color(255, 255, 255));

        cmdMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/menu/icon/menu.png"))); // NOI18N

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/menu/icon/profile.png"))); // NOI18N
    ...
    private gui.menu.swing.ButtonBadges buttonBadges1;
    private gui.menu.swing.ButtonBadges buttonBadges2;
    private gui.menu.swing.Button cmdMenu;
    private javax.swing.JSeparator jSeparator1;
    private javax.swing.JLabel lbRole;
    private javax.swing.JLabel lbUserName;
    private gui.menu.swing.ImageAvatar pic;
