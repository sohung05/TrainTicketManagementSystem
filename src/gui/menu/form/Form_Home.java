package gui.menu.form;

import gui.menu.model.ModelCard;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        card1 = new gui.menu.component.Card();
        jLabel1 = new javax.swing.JLabel();
        card2 = new gui.menu.component.Card();
        card3 = new gui.menu.component.Card();
        card4 = new gui.menu.component.Card();
    ...
    private gui.menu.component.Card card1;
    private gui.menu.component.Card card2;
    private gui.menu.component.Card card3;
    private gui.menu.component.Card card4;
